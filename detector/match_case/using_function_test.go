...
func TestSelectMax(t *testing.T) {
	...
	tests := []Test{
		...
		{
			Input:  `time=1970-01-01T11:12:00.000+09:00 level=info msg="select max(id) from examples;"`,
			Expect: true,
		},
		{
			Input:  `time=1970-01-01T11:12:00.000+09:00 level=info msg="select id from examples;"`,
...
func TestSelectMin(t *testing.T) {
	...
	tests := []Test{
		...
		{
			Input:  `time=1970-01-01T11:12:00.000+09:00 level=info msg="select min(id) from examples;"`,
			Expect: true,
		},
		{
			Input:  `time=1970-01-01T11:12:00.000+09:00 level=info msg="select id from examples;"`,
...
func TestSelectAvg(t *testing.T) {
	...
	tests := []Test{
		...
		{
			Input:  `time=1970-01-01T11:12:00.000+09:00 level=info msg="select avg(id) from examples;"`,
			Expect: true,
		},
		{
			Input:  `time=1970-01-01T11:12:00.000+09:00 level=info msg="select id from examples;"`,
